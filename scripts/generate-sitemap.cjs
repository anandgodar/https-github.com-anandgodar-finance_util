...
const BLOG_POSTS = [
  ...
  'leanfire-vs-fatfire-lifestyle-budget', '4-percent-rule-dead-safe-withdrawal-rates',
  ...
  'bonus-tax-myth-withholding-vs-liability', 'overtime-tax-myth-withholding-vs-tax-rate',
  ...
  'second-job-marginal-vs-effective-rate', 'no-tax-on-tips-explained-2025',
];
