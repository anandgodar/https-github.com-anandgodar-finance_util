...
export enum ToolType {
  ...
  MORTGAGE_CALCULATORS_HUB = 'mortgage-calculators',
  INVESTMENT_CALCULATORS_HUB = 'investment-calculators',
  MORTGAGE_CALCULATOR_COMPARISON = 'best-mortgage-calculator-2025',
