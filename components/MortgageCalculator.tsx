      ...
      <section className="bg-white border border-slate-200 rounded-3xl p-8">
        ...
        <div className="prose prose-slate max-w-none space-y-4">
          ...
          <p className="text-slate-600 text-sm mt-2">
            Practical fix: when you run this calculator before closing, try the numbers twice — once with the seller's current assessed value, once with your actual purchase price — so you see the realistic range for your first year's tax line rather than a single, possibly-understated figure.
          </p>
        </div>
      </section>
