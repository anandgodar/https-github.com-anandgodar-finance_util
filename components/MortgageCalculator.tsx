      ...
      <section className="bg-white border border-slate-200 rounded-3xl p-8">
        ...
        <div className="prose prose-slate max-w-none space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
            ...
            <li><strong>Result:</strong> a shortage the servicer recovers alongside a higher ongoing monthly payment going forward, sized to fully fund the new, higher estimate plus a legally permitted cushion. How the past shortfall itself gets collected depends on its size: a shortage smaller than one month's escrow payment can be billed as a lump sum due within 30 days; a shortage of a month's payment or more <strong>cannot</strong> be demanded as a lump sum at all — the servicer must either let it ride or spread it over at least 12 months (12 CFR 1024.17(f)(3))</li>
          </ul>
          <p className="text-slate-700 leading-relaxed font-medium">
      ...
      <CalculatorFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer: "Your servicer runs an annual escrow analysis comparing what it actually paid out in property tax and insurance over the past year against what it collected from you. If your first year's escrow was funded on a pre-reassessment tax estimate and an initial insurance quote, and the real reassessed tax bill plus a renewal insurance premium both came in higher, you'll owe the shortfall, plus a higher ongoing monthly amount sized to the new, higher estimate. How the shortfall itself gets collected depends on its size, not the servicer's preference: under Regulation X, a shortage smaller than one month's escrow payment can be billed as a lump sum due within 30 days, but a shortage of a month's payment or more cannot be demanded as a lump sum at all — the servicer must either let it ride or spread it over at least 12 months (12 CFR 1024.17(f)(3)). This is separate from the reassessment gap itself: the reassessment explains why the tax estimate was too low; the escrow shortage is your servicer catching the account up once it has real bills to compare, about a year after closing. Federal Regulation X also requires an annual escrow statement showing this math and caps the cushion a servicer can hold at one-sixth of your yearly disbursements."
          },
          {
